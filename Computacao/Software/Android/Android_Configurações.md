# Android | Configurações que eu sempre faço

Abaixo estão as configurações que eu costumo aplicar sempre que configuro um **dispositivo Android**. Essas alterações ajudam a melhorar o desempenho, aumentar a duração da bateria e personalizar o sistema conforme o meu uso.

---

## 1. **Ativar Modo Desenvolvedor**

- **Passo 1**: Vá em **Configurações** > **Sobre o telefone**.
- **Passo 2**: Toque em **Número da versão** 7 vezes até que o modo desenvolvedor seja ativado.
- **Passo 3**: Em **Configurações**, você verá uma nova opção chamada **Opções do desenvolvedor**. Ative-a e personaliza conforme necessário.

---

## 2. **Desativar Animações**

Desativar as animações do sistema pode ajudar a **melhorar o desempenho** e fazer o dispositivo ficar mais rápido.

- **Passo 1**: Ative o **Modo Desenvolvedor** (como no item anterior).
- **Passo 2**: Vá em **Opções do desenvolvedor**.
- **Passo 3**: Desative as animações:
  - **Escala de janela**: Defina como **0.5x** ou **Desativado**.
  - **Escala de transição**: Defina como **0.5x** ou **Desativado**.
  - **Escala de duração do animator**: Defina como **0.5x** ou **Desativado**.

---

## 3. **Aumentar a Largura da Tela para 437dp**

Se você deseja ajustar a **largura da tela** para 437dp (para melhor visualização em dispositivos com telas grandes ou resolução mais alta):

- **Passo 1**: Acesse **Configurações** > **Sobre o telefone** > **Opções do desenvolvedor**.
- **Passo 2**: Encontre a opção **Largura de tela** (ou **Tamanho da tela**).
- **Passo 3**: Ajuste a largura para **437dp**.

---

## 4. **Desativar Processos em Segundo Plano**

Para **melhorar o desempenho** e **economizar bateria**, é importante limitar os processos em segundo plano.

- **Passo 1**: Vá em **Opções do desenvolvedor**.
- **Passo 2**: Encontre a opção **Limitar processos em segundo plano** e defina para o número mínimo de processos, ou selecione **Não mais de 4 processos em segundo plano**.

---

## 5. **Restringir Bateria em Aplicativos**

Para melhorar o consumo da bateria, você pode restringir certos aplicativos de rodarem em segundo plano.

- **Passo 1**: Vá em **Configurações** > **Bateria** > **Uso da bateria**.
- **Passo 2**: Selecione os aplicativos que você não deseja que consumam bateria em segundo plano.
- **Passo 3**: Defina como **"Restrição de fundo"**.

---

## 6. **Desabilitar Aplicativos de Fábrica**

Alguns aplicativos que vêm pré-instalados no Android podem consumir recursos e não são úteis para todos os usuários. Aqui estão alguns aplicativos que você pode desabilitar:

- **Google**: Se você não utiliza os serviços do Google, pode desabilitar o **Google App** (não sei exatamente pra que serve, mas ele pode ser desabilitado).
- **Facebook e Netflix**: Caso você não utilize esses aplicativos e eles estejam pré-instalados, você pode desabilitá-los.
  
  **Passo para desabilitar**: 
  - Vá em **Configurações** > **Aplicativos** > Selecione o aplicativo (exemplo: **Facebook**, **Netflix**).
  - Clique em **Desabilitar**.

---

## 7. **Desativar Android Auto**

Se você não utiliza o **Android Auto** (funcionalidade para carros), é uma boa ideia desativá-lo.

- **Passo 1**: Vá em **Configurações** > **Aplicativos** > **Android Auto**.
- **Passo 2**: Toque em **Desativar**.

---

## 8. **Desativar Google Maps**

Se você não usa muito o **Google Maps** e prefere usar o navegador, você pode desativá-lo.
