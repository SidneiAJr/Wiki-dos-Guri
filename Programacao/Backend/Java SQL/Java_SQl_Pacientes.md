...
> Importante:
> final String URL = "jdbc:mysql://localhost:3306/";  <----- Aqui na criacao da tabela referenciar ao JBDC o caminho do banco ⚠️ Cuidado com Letras Maiusculas e Minusculas
